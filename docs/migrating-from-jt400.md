...
| `package criteria` | `package-criteria` | M10 + v0.7.7. `default` / `select` / `extended` — mirrors JT400's three criteria from [`JDSQLStatement.java`](https://github.com/IBM/JTOpen/blob/main/src/main/java/com/ibm/as400/access/JDSQLStatement.java). `extended` additionally files `CALL` / `VALUES` / `WITH`. |
